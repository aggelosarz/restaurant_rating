...
<img src="images/<c:out value='${sessionScope.rest.getFilename()}'/>" name="myProfil" id="profil" width="200" height="200" alt="notFound" class="img-fluid" >
     
  </div>
 
 <div class="form-group" >
    <label for="restName">Όνομα Εστιατορίου</label>
    <input type="text" class="form-control" name="restName" id="restName" value="<c:out value="${sessionScope.rest.getRestaurantName()}" />"required>
  </div>
  <div class="form-group" >
    <label for="type">Κουζίνα</label>
      <select id="type" name="type" class="form-control" value="<c:out value='${sessionScope.rest.getType()}'/>"required>
  ...
  <div class="form-row">
    ...
    <input type="text" class="form-control" id="inputAddress" name="adress" placeholder="1234 Main St" value="<c:out value='${sessionScope.rest.getAdress()}'/>">
    </div>
  ...
  <div class="form-group">
    ...
    <textarea class="form-control" id="exampleFormControlTextarea1" name="infos" rows="3"><c:out value="${sessionScope.rest.getDescription()}" /></textarea>
  </div>
