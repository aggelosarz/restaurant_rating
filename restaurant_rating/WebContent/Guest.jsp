  ...
  <%}} %>
    ...
    <tbody>
     <c:forEach items="${requestScope.Rest}" var="s">
      <tr>
        <td><a href="RestaurantController?action=search&user=guest&restName=<c:out value='${s.getRestaurantName()}'/>&city=<c:out value='${s.getCity()}'/>&type=<c:out value='${s.getType()}'/>"><c:out value='${s.getRestaurantName()}'/></a></td>
